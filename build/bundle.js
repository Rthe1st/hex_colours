...
function boardSettingsGui(gui) {}

var Board = (function () {
    function Board(game, dataString, sideLength) {
    ...
    _createClass(Board, [{
        ...
        value: function destroy() {
            ...
            try {
                for (var _iterator = this.hexagons[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    var row = _step.value;
            ...
            try {
                for (var _iterator2 = this.combinedSides[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        value: function updateSideLength(sideLength) {
            ...
            try {
                for (var _iterator7 = this.hexagons[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
            ...
            try {
                for (var _iterator8 = this.combinedSides[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                    var combinedSide = _step8.value;
        ...
        get: function get() {
            ...
            try {
                for (var _iterator10 = this.hexagons[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
                    ...
                    try {
                        for (var _iterator11 = row[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
                            ...
                            try {
                                for (var _iterator12 = hexagon.sides[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
    ...
    for (var x = 0; x < hexagons.length; x++) {
        for (var y = 0; y < hexagons[x].length; y++) {
            ...
            for (var sideNumber = 0; sideNumber < 6; sideNumber++) {
                ...
                if (!hexagon2Exists) {
                    combinedSides.push(new _combinedSideJs.CombinedSide(game, hexInfo, sideLength));
...
function parseDataString(string, sideLength, game) {
    ...
    try {
        for (var _iterator13 = string.split("r").entries()[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
            var _step13$value = _slicedToArray(_step13.value, 2);

            var x = _step13$value[0];
            var rowData = _step13$value[1];

            var row = parseRowString(rowData, sideLength, x, game);
            hexagons.push(row);
        }
    } catch (err) {
...
function parseRowString(rowString, sideLength, x, game) {
    ...
    try {
        for (var _iterator14 = rowString.split("h").entries()[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
            var _step14$value = _slicedToArray(_step14.value, 2);

            var y = _step14$value[0];
            var hexagonData = _step14$value[1];

            var hexagon = parseHexString(hexagonData, sideLength, { x: x, y: y }, game);
...
function parseHexString(hexagonString, sideLength, cords, game) {
    var sides = hexagonString.split(":");
    if (sides.length !== 6) {
        console.log("invalid map string hexagon");
        console.log(hexagonString);
    }
    var hexagon = new _hexagonJs.Hexagon(sideLength, cords, game, sides);
    hexagon.drawSides();
    return hexagon;
}

},{"./combinedSide.js":5,"./hexagon.js":7}],5:[function(require,module,exports){
"use strict";
...
var CombinedSide = (function () {
    function CombinedSide(game, hexagonInfos, length) {
    ...
    _createClass(CombinedSide, [{
        ...
        value: function draw() {
            this.graphics.clear();
            var firstTeam = this.hexagonInfos[0].hexagon.sides[this.hexagonInfos[0].side];
            var colour = undefined;
            if (this.hexagonInfos.length === 2) {
                var secondTeam = this.hexagonInfos[1].hexagon.sides[this.hexagonInfos[1].side];
                colour = this.manualCombine(firstTeam, secondTeam);
            } else {
                colour = _teamInfoJs.teams[firstTeam].colour;
            }
            this.graphics.lineStyle(lineStyle.thickness, colour, lineStyle.alpha);
            var hexPoints = geometry.relativeScaledHexPoints(this.length);
        ...
        value: function manualCombine(first_team, second_team) {
            ...
            var temp = Math.max(first_team, second_team);
            first_team = Math.min(first_team, second_team);
            second_team = temp;
            var _arr = [first_team, second_team];
            for (var _i = 0; _i < _arr.length; _i++) {
                var team = _arr[_i];
                if (team < 0 || team > _teamInfoJs.teams.length) {
                    logError();
                }
            }
            if (first_team === second_team) {
                return _teamInfoJs.teams[first_team].colour;
...
},{"./geometry.js":6,"./teamInfo.js":10}],6:[function(require,module,exports){
"use strict";
...
var Hexagon = (function () {
    function Hexagon(outerSideLength, gridCords, game, sides) {
    ...
    _createClass(Hexagon, [{
        ...
        value: function drawSides() {
            ...
            var hexPoints = geometry.relativeScaledHexPoints(this.innerSideLength);
            for (var sideNumber = 0; sideNumber < 6; sideNumber++) {
                var colour = _teamInfoJs.teams[this.sides[sideNumber]].colour;
        ...
        key: "worldCords",
        get: function get() {
            var ySpacing = 2 * Math.sin(Math.PI / 3) * this.outerSideLength;
            var xSpacing = this.outerSideLength * 1.5;
            ...
            var isOddColumn = this.gridCords.x % 2 == 1;
            if (isOddColumn) {
...
},{"./geometry.js":6,"./teamInfo.js":10}],8:[function(require,module,exports){
...
var globalParams = {
    ...
    gridWidth: 2,
    gridHeight: 2,
    sideGeneration: "random" };

//be nice to store function directly here but doesn't play nice with dat-gui,
...
function onCreate(game) {
    ...
    (0, _boardJs.boardSettingsGui)(settingsGui);
    (0, _hexagonJs.hexagonSettingsGui)(settingsGui);
    (0, _combinedSideJs.combinedSideSettingsGui)(settingsGui);
    (0, _teamInfoJs.teamInfoSettingsGui)(settingsGui);
}
...
function buildBoard(game, boardData) {
    if (globalParams.sideGeneration !== "dataString") {
        ...
        boardData = generationFunction(_teamInfoJs.teams, globalParams.gridWidth, globalParams.gridHeight);
        globalParams.sideLength = calculateSideLength(globalParams.width, globalParams.height, globalParams.gridWidth, globalParams.gridHeight);
    }
    var board = new _boardJs.Board(game, boardData, globalParams.sideLength);
...
},{"./board.js":4,"./combinedSide.js":5,"./hexagon.js":7,"./sideGeneration.js":9,"./teamInfo.js":10,"dat-gui":1}],9:[function(require,module,exports){
"use strict";
